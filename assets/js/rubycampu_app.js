...
var rubycampusApp = angular.module('rubycampusApp', [
    'ui.router',
    'oc.lazyLoad',
    'ngSanitize',
    'ngRetina',
...
// breadcrumbs
rubycampusApp.config(function($breadcrumbProvider) {
            ...
            return {
                ...
                link: function() {
                    var listener = function(event, toState) {
                        var default_title = 'RubyCampus Admin';
                        $timeout(function() {
