angular
    ...
    .controller('calendarCtrl', [
        ...
        '$localStorage',
        '$http','setting_data',
        function ($scope, uiCalendarConfig, $resource, $filter,$localStorage,$http,setting_data) {
            ...
            $scope.addEvent=function(){
                console.log(sendStartTime,'$scope.startTime');
                $http({
                    method:'GET',
                    // url: $localStorage.service+'TimetableAPI/calendarDetails',
                ...
                var message;
                        ...
                        if (!message) {
                            ...
                            if ( modal.isActive() ) {
                                ...
                                // $scope.addEvents={};
                                // $scope.addEvents={start_date : start, end : end};
                                console.log(setStartDay,'-setStartDay',setStarttime);
                                $scope.day=StartDay;
                                $scope.startTime=moment(setStarttime, ["hh:mm A"]).format("hh:mm A");
                                $scope.endTime=moment(setEndtime, ["hh:mm A"]).format("hh:mm A");
                                sendStartTime=$scope.startTime;
