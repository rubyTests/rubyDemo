angular
    ...
    .controller('calendareventsCtrl', [
        ...
        function ($scope,uiCalendarConfig,$filter,$resource) {
            ...
            // $scope.departmentData = ['department1', 'department2', 'department3', 'department4', 'department5', 'department6', 'department7'];
            // $scope.courseData = ['course1', 'course2', 'course3', 'course4', 'course5', 'course6', 'course7'];
            // $scope.batchData = ['batch1', 'batch2', 'batch3', 'batch4', 'batch5', 'batch6', 'batch7'];
            ...
            $scope.uiConfig = {
                calendar: {
                    ...
                    viewRender: function(view) {
                        var title = "<h1 style='font-size:24px;line-height:48px'>News and Events</h1>";
                        $(".fc-left").html(title);
                    },
                    buttonIcons: {
            ...
            $scope.calendar_events = [
                ...
                // },
                {
                    title: 'Test Event',
                    url: 'http://google.com',
                    start: moment("2017-03-15").startOf('day').add(10.50, 'hours').format('YYYY-MM-DD HH:mm'),
                    end: moment("2017-03-15").startOf('day').add(11.50, 'hours').format('YYYY-MM-DD HH:mm'),
                    color: '#0097a7'
                }
            ];
