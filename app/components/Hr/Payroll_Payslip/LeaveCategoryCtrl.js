angular
    ...
    .controller('tables_examplesCtrl', [
        ...
        'editableThemes',
        'Leave_Category',
        function ($scope,$timeout,editableOptions, editableThemes,Leave_Category) {
            ...
            $scope.Leave_Category=Leave_Category;
            $scope.PayItemRepeatData =[].concat($scope.Leave_Category);
            $scope.itemsByPage=5;
            // $scope.rowCollection = [
