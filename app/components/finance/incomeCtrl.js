        ...
        function($compile, $scope, $timeout, $resource, DTOptionsBuilder, DTColumnDefBuilder,$http,$rootScope, $filter,$localStorage) {
            ...
            vm.dtOptions = DTOptionsBuilder
                ...
                $scope.getdata=function(){
                    // $http.get($localStorage.service+'FinanceAPI/transactionDetails ',{params:{'type':'Income'},headers:{'access_token':$localStorage.access_token}})
                ...
                $scope.saveIncome=function(){
                    var inc_date = $scope.income_date.split(".");
                    $scope.INCOMEDATE = inc_date[2]+"-"+inc_date[0]+"-"+inc_date[1];
                    ...
                    if($scope.inputform.$valid==true){
                        ...
                        data: {
                            ...
                            'TRANSACTION_DATE' : $scope.INCOMEDATE,
                        ...
                        headers:{'access_token':$localStorage.access_token}
                            ...
                            if(return_data.data.message.status==true){
                                ...
                                UIkit.modal.alert('Income Name Already Exists');
                            }
                        });
                    }
                }
