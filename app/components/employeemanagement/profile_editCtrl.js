                ...
                var img_file=$('.fileinput-preview').find('img').attr('src');
                 $http({
                    ...
                    data: {
                        ...
                        'Profile_id' :$scope.user_data.PROF_ID,
                        'dob' :$scope.user_data.DOB,
                        'image_file' :img_file,
                        'natoinality' :$scope.user_data.NATION_ID,
                        'marital' :$scope.user_data.MARITAL_ID,
                        ...
                        'category' :$scope.user_data.CAT_ID,
                        ...
                        'Profile_extra_id' :$scope.user_data.P_EXTRA_ID,
